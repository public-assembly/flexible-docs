...
Saving changes requires writing to the theme registry. Note that this action requires gas. Conducting this transaction establishes a new JSON reference for your site. Additionally, admins can assign managers who are also able to make updates to the site's theme. 

[Learn how to manage roles](/docs/theming/manage_roles/).
</Steps>
