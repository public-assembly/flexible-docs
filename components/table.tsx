...
export function OptionTable({ options }: { options: [string, any] }) {
    ...
    >
        ...
        <thead>
            ...
            <th className="py-2 px-6 font-semibold">Value</th>
            </tr>
        </thead>
        <tbody className="align-baseline text-gray-900 dark:text-gray-100">
            ...
            >
                <td className="whitespace-pre py-2 font-mono text-xs font-semibold leading-6  text-green-300 dark:text-green-300">
                {option} </td>
